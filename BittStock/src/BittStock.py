...
logo_path = "D:\\.vscode\\new\\loo.png"  # Replace with the path to your logo
image = Image.open(logo_path)
logo = ImageTk.PhotoImage(image.resize((180, 180)))  # Resize as needed

# Create a label for the logo and place it in the top-left
logo_label = tk.Label(root, image=logo)
logo_label.place(x=0, y=0, anchor="nw")  # 'nw' ensures it's pinned to the top-left corner
